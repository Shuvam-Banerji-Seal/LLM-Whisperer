...
content = """# vLLM and Fast LLM Serving - Master Agentic Skill Prompt 
...
python -m vllm.entrypoints.openai.api_server \
    --model meta-llama/Llama-3-400b-Instruct \
...
python -m vllm.entrypoints.openai.api_server \
    ...
    --max-loras 4 \
    --max-lora-rank 64 \
    --lora-modules sql-lora=/path/to/sql css-lora=/path/to/css
```
...
with open('/home/shuvam/codes/LLM-Whisperer/skills/fast-inference/vllm-and-serving.prompt.md', 'w') as f:
    f.write(content)
print("Massive skill file for vLLM created successfully.")
